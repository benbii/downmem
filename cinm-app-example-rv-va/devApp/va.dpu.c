...
void va_8() {
  ...
  int32_t v3 = v2 * 1024;
  int32_t v4 = v1 + v3;
  int32_t *v5 = mem_alloc(256 * sizeof(int32_t));
  int32_t v6 = v1 + 16384;
  int32_t v7 = v6 + v3;
  int32_t *v8 = mem_alloc(256 * sizeof(int32_t));
  int32_t v9 = v6 + 16384;
  int32_t v10 = v9 + v3;
  int32_t *v11 = mem_alloc(256 * sizeof(int32_t));
...
void va_16() {
  ...
  int32_t v9 = v6 + 16384;
  int32_t v10 = v9 + v3;
  int32_t *v11 = mem_alloc(512 * sizeof(int32_t));
