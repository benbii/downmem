...
void mv_dimm4_opt() {
  ...
  int32_t v3 = v2 * 8192;
  int32_t v4 = v1 + v3;
  int32_t *v5 = mem_alloc(2048 * sizeof(int32_t));
  int32_t v6 = v1 + 8192;
  int32_t v7 = v6 + v3;
  int32_t *v8 = mem_alloc(2048 * sizeof(int32_t));
  int32_t v9 = v6 + 8192;
  int32_t v10 = v2 * 8;
  int32_t v11 = v9 + v10;
  int32_t *v12 = mem_alloc(2 * sizeof(int32_t));
...
void mv_dimm8_nopt() {
  ...
  int32_t v3 = v2 * 2048;
  int32_t v4 = v1 + v3;
  int32_t *v5 = mem_alloc(512 * sizeof(int32_t));
  int32_t v6 = v1 + 2048;
  int32_t v7 = v6 + v3;
  int32_t *v8 = mem_alloc(512 * sizeof(int32_t));
  int32_t v9 = v6 + 2048;
  int32_t v10 = v2 * 8;
  int32_t v11 = v9 + v10;
  int32_t *v12 = mem_alloc(2 * sizeof(int32_t));
...
void mv_dimm16_opt() {
  ...
  int32_t v3 = v2 * 512;
  int32_t v4 = v1 + v3;
  int32_t *v5 = mem_alloc(128 * sizeof(int32_t));
  int32_t v6 = v1 + 512;
  int32_t v7 = v6 + v3;
  int32_t *v8 = mem_alloc(128 * sizeof(int32_t));
  int32_t v9 = v6 + 512;
  int32_t v10 = v2 * 8;
  int32_t v11 = v9 + v10;
  int32_t *v12 = mem_alloc(2 * sizeof(int32_t));
